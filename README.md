...
Semian also includes an experimental adaptive circuit breaker that uses a simple proportional controller
...
- proportional controller gains optimized for stability and responsiveness
