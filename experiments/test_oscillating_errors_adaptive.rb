...
begin
  init_resource = Semian::Experiments::ExperimentalResource.new(
    name: "protected_service_oscillating_adaptive",
    service: service,
...
monitor_thread = Thread.new do
  ...
  until done
    begin
      semian_resource = Semian["protected_service_oscillating_adaptive".to_sym]
...
puts "\n=== Oscillating Error Test (ADAPTIVE) ==="
...
graph.title = "Adaptive Circuit Breaker: Oscillating Errors (2% <-> 6%)"
...
graph.write("oscillating_errors_adaptive.png")

puts "Graph saved to oscillating_errors_adaptive.png"
