...
test_duration = 180 # 3 minutes total

puts "\n=== Sustained Load Test (CLASSIC) ==="
puts "Phase 1: Baseline 1% error rate (1 minute)"
puts "Phase 2: High 90% error rate (1 minute)"
puts "Phase 3: Return to baseline 1% error rate (1 minute)"
...
graph.title = "Classic Circuit Breaker: Sudden 90% Error Spike"
...
graph.write("sudden_error_spike_#{timestamp}.png")

puts "Graph saved to sudden_error_spike_#{timestamp}.png"
