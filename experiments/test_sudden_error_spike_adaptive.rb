...
# Semian configuration for adaptive circuit breaker
semian_config = {
...
puts "\n=== Sudden Error Spike Load Test (ADAPTIVE) ==="
puts "Error rate: 1% -> 90% (sudden spike) -> 1%"
puts "Duration: #{test_duration} seconds (0.5 minutes)"
puts "Starting test...\n"
...
graph.title = "Adaptive Circuit Breaker: Sudden 90% Error Spike"
...
graph.write("sudden_error_spike_adaptive_#{timestamp}.png")

puts "Graph saved to sudden_error_spike_adaptive_#{timestamp}.png"
