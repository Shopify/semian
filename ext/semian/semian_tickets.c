...
static void initialize_tickets(int sem_id, int tickets, double quota)
{
...
static void configure_static_tickets(int sem_id, int tickets)
{
  int state;
...
static void configure_quota_tickets(int sem_id, double quota)
{
  int state;
